...
class UserAccountViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self.userAccountView as Any, selector: #selector(self.userAccountView?.keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
        
        NotificationCenter.default.addObserver(self.userAccountView as Any, selector: #selector(self.userAccountView?.keyboardWillHide), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
